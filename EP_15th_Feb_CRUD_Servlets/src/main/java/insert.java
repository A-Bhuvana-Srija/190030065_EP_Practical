			  ...
			  if(i>0)
			  {
				  out.println("<html><head><style>\r\n"
				   ...
				   out.println("<div class=\"bg\"></div>\r\n"
				   		...
				   		+ "	<div class=\"box1\">");
				  	pw.print("<center><p> Record is Inserted Successfully! </p><center>");
				  	pw.print("<center><a href='view'><input type = 'submit' value = 'TAP HERE TO VIEW THE INSERTED DETAILS'></a></center>");
			  } 
			  else
			  { 
